...
/**
 * Strings for component 'block_xp', language 'pt_br', branch 'MOODLE_34_STABLE'
 *
 * @package   block_xp
...
$string['reverttopluginsdefaults'] = 'Reverter os padrões do plugin';
$string['reverttopluginsdefaultsintro'] = 'Use o botão abaixo se desejar reverter para os padrões do plugin.';
$string['rule'] = 'Regra';
