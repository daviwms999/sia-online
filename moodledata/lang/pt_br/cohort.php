...
/**
 * Strings for component 'cohort', language 'pt_br', branch 'MOODLE_34_STABLE'
 *
 * @package   cohort
...
* Os campos opcionais são idnumber, description, descriptionformat, context,  category, category_id, category_idnumber, category_path';
