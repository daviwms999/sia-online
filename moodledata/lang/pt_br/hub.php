...
/**
 * Strings for component 'hub', language 'pt_br', branch 'MOODLE_34_STABLE'
 *
 * @package   hub
...
$string['advertise'] = 'Publique este curso para pessoas se inscreverem';
$string['advertised'] = 'Anunciados';
$string['advertiseon'] = 'Publique este curso em {$a}';
$string['advertiseonhub'] = 'Publique este curso em um hub';
$string['advertiseonmoodleorg'] = 'Anuncie esse curso em moodle.org';
$string['advertisepublication_help'] = 'Este curso será listado no Moodle.net como um curso que as pessoas podem se inscrever e participar. Autenticação via correio eletrônico deve estar habilitada no site e você precisa ativar a auto-inscrição neste curso.';
$string['all'] = 'Todos';
...
$string['errorotherhubsnotsupported'] = 'Esta página não pode mais ser utilizada para registro com sites diferentes do Moodle.net';
...
$string['notregisteredonhub'] = 'O administrador precisa registrar este site em Moodle.net para que você possa publicar um curso.';
...
$string['sitecommnews_help'] = 'Você tem a opção de se inscrever na nossa lista de e-mails, incluindo um boletim informativo sobre acontecimentos na comunidade Moodle.';
$string['sitecommnewsno'] = 'Não, eu não quero receber nenhum e-mail de Moodle HQ';
$string['sitecommnewsyes'] = 'Sim, por favor, inclua-me no boletim eletrônico de novidades do Moodle';
$string['sitecountry'] = 'País';
$string['sitecountry_help'] = 'O país em que sua organização ou instituição está localizada.';
...
$string['siteregistrationemail'] = 'Notificações sobre questões importantes de segurança e técnicas.';
$string['siteregistrationemail_help'] = 'Você tem a opção de assinar nossa lista de e-mails para receber notícias importantes (sobre problemas de segurança ou novos lançamentos).';
...
$string['unpublishalladvertisedcourses'] = 'Excluir todos os cursos publicados para inscrição no Moodle.net';
$string['unpublishalluploadedcourses'] = 'Excluir todos os cursos publicados para baixar no Moodle.net';
