...
/**
 * Strings for component 'mlbackend_python', language 'pt_br', branch 'MOODLE_34_STABLE'
 *
...
$string['pythonpackagenotinstalled'] = 'O pacote "moodlemlbackend" python não está instalado ou há um problema com ele. Por favor execute "{$a}" na interface de linha de comando para mais informações';
