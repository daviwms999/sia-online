...
/**
 * Strings for component 'gradingform_rubric', language 'pt_br', branch 'MOODLE_34_STABLE'
 *
...
$string['err_scoreformat'] = 'O número de pontos para cada nível precisa ser um número válido';
