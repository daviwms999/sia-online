...
/**
 * Strings for component 'enrol', language 'pt_br', branch 'MOODLE_34_STABLE'
 *
 * @package   enrol
...
$string['unenrolconfirm'] = 'Você quer mesmo desinscrever o usuário "{$a->user}" (inscrito anteriormente via "{$a->enrolinstancename}") do curso "{$a->course}"?';
