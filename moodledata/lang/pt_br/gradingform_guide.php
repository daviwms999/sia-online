...
/**
 * Strings for component 'gradingform_guide', language 'pt_br', branch 'MOODLE_34_STABLE'
 *
...
$string['err_scoreinvalid'] = 'A pontuação atribuída no {$a->criterianame} não é válida, pois a pontuação máxima é: {$a->maxscore}';
