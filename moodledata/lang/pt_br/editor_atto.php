...
/**
 * Strings for component 'editor_atto', language 'pt_br', branch 'MOODLE_34_STABLE'
 *
 * @package   editor_atto
...
$string['taskautosavecleanup'] = 'Excluir rascunhos de salvamento automático expirados do banco de dados.';
