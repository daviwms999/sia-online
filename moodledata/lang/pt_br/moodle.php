...
/**
 * Strings for component 'moodle', language 'pt_br', branch 'MOODLE_34_STABLE'
 *
 * @package   moodle
...
$string['allowstealthmodules_help'] = 'Se ativado, atividades podem ficar disponíveis, mas não visíveis em tópicos ativos na página do curso. Se assim for, é necessário providenciar links para as atividades ocultas de algum outro lugar, como um recurso tipo página. Atividades ocultas continuam a ser listadas no livro de notas e outros relatórios.';
...
$string['considereddigitalminor'] = 'Você é considerado um menor digital.';
...
$string['coursealreadyfinished'] = 'Curso já finalizado';
...
$string['coursenotyetfinished'] = 'O curso ainda não finalizou';
$string['coursenotyetstarted'] = 'O curso ainda não iniciou';
...
$string['digitalminor_desc'] = 'Para criar uma conta neste site, peça para que seus pais ou responsáveis entrem em contato com a seguinte pessoa.';
...
$string['emailuserhasnone'] = 'Não há endereço de email para o usuário.';
...
$string['explanationdigitalminor'] = 'Essas informações são necessárias para determinar se sua idade é superior a idade digital de consentimento. Essa é a idade em que um indivíduo pode aceitar os termos e condições e permitir que seus dados sejam legalmente armazenados e processados.';
...
$string['indicator:nostudent'] = 'Não há estudantes';
$string['indicator:nostudent_help'] = 'Este indicador reflete que não há estudantes neste curso.';
$string['indicator:noteacher'] = 'Não há professores';
$string['indicator:noteacher_help'] = 'Este indicador reflete que não há professores neste curso.';
...
$string['nocourseactivity'] = 'Não há atividade suficiente no curso entre o início e o final do curso';
$string['nocourseendtime'] = 'O curso não possui uma data de fim';
$string['nocourses'] = 'Nenhum curso';
$string['nocoursesections'] = 'Curso sem seções';
$string['nocoursesfound'] = 'Nenhum curso encontrado com as palavras \'{$a}\'';
$string['nocoursestarttime'] = 'O curso não possui uma data de início';
...
$string['privacy:metadata:events_queue:userid'] = 'O id do usuário relacionado a este evento.';
...
$string['privacy:metadata:log:time'] = 'A data em que a ação aconteceu';
$string['privacy:metadata:log:userid'] = 'O ID do usuário que executou a ação';
$string['privacy:metadata:task_adhoc'] = 'O status das tarefas ad hoc.';
...
$string['quotausage'] = 'Você está usando {$a->used} do seu limite de {$a->total}.';
...
$string['registrationno'] = 'Não, não quero receber email do Moodle HQ';
$string['registrationsend'] = 'Mande a informação de registro para moodle.org';
$string['registrationyes'] = 'Sim, avise-me sobre notícias importantes (por exemplo, problemas de segurança ou novidades)';
...
$string['tags'] = 'Tags';
$string['target:coursedropout'] = 'Estudantes com risco de abandonar';
$string['target:coursedropout_help'] = 'Este alvo descreve se o estudante é considerado em risco de abandono.';
$string['targetlabelstudentdropoutno'] = 'Não está em risco';
$string['targetlabelstudentdropoutyes'] = 'Estudantes com risco de abandonar';
$string['targetlabelteachingno'] = 'Sem ensino';
$string['targetlabelteachingyes'] = 'Usuários com capacidades de ensino têm acesso ao curso';
$string['target:noteachingactivity'] = 'Sem ensino';
$string['target:noteachingactivity_help'] = 'Este alvo descreve se os cursos que devem começar na próxima semana terão atividade de ensino.';
...
$string['timesplitting:decilesaccum'] = 'Décimos acumulativos';
$string['timesplitting:decilesaccum_help'] = 'Esse método de divisão de tempo divide o curso em décimos (10 partes iguais), sendo cada previsão baseada nos dados de todos os  décimos anteriores.';
$string['timesplitting:deciles_help'] = 'Esse método de divisão de tempo divide o curso em décimos (10 partes iguais), sendo cada previsão baseada apenas nos dados do décimo anterior mais recente.';
$string['timesplitting:nosplitting'] = 'Sem divisão de tempo';
$string['timesplitting:nosplitting_help'] = 'Sem método divisão de tempo definido para este modelo';
$string['timesplitting:quarters'] = 'Quartos';
$string['timesplitting:quartersaccum'] = 'Quartos acumulativos';
$string['timesplitting:quartersaccum_help'] = 'Esse método de divisão de tempo divide o curso em quartos (4 partes iguais), sendo cada previsão baseada nos dados de todos os quartos anteriores.';
$string['timesplitting:quarters_help'] = 'Esse método de divisão de tempo divide o curso em quartos (4 partes iguais), sendo cada previsão baseada apenas nos dados do quarto anterior mais recente.';
$string['timesplitting:singlerange'] = 'Intervalo simples';
$string['timesplitting:singlerange_help'] = 'Este método de divisão de tempo considera todo o curso como um único período.';
$string['timesplitting:weekly'] = 'Semanalmente';
$string['timesplitting:weeklyaccum'] = 'Acumulado semanalmente';
$string['timesplitting:weeklyaccum_help'] = 'Esse método de divisão de tempo divide o curso em semanas (7 dias), sendo cada previsão baseada nos dados de todas as semanas anteriores.';
$string['timesplitting:weekly_help'] = 'Esse método de divisão de tempo divide o curso em semanas (7 dias), sendo cada previsão baseada apenas nos dados da semana anterior mais recente.';
...
$string['wheredoyoulive'] = 'Em que país você mora?';
