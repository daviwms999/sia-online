...
/**
 * Strings for component 'webservice', language 'pt_br', branch 'MOODLE_34_STABLE'
 *
 * @package   webservice
...
$string['onlyseecreatedtokens'] = 'Qualquer token pode ser excluído, embora você só possa ver os tokens que você criou.';
