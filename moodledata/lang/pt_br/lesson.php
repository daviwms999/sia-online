...
/**
 * Strings for component 'lesson', language 'pt_br', branch 'MOODLE_34_STABLE'
 *
 * @package   lesson
...
$string['essayemailmessage2'] = '<p>Questão de Dissertação: {$a->question}</p>
<p>Sua resposta: <em>{$a->response}</em></p>
<p>Comentário do avaliador: <em>{$a->comment}</em></p>
<p>Você recebeu {$a->earned} por {$a->outof} por esta questão dissertativa.</p>
<p>Sua nota para a lição foi modificada para {$a->newgrade}%.</p>';
