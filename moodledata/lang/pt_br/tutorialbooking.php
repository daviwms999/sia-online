...
/**
 * Strings for component 'tutorialbooking', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
...
$string['adminiconprompt'] = 'Usar ícones?';
...
$string['adminwaitinghelp'] = 'Habilitando isso permitirá listas de espera em sessões de slot de tempo';
$string['adminwaitingprompt'] = 'Habilitar funcionalidade da Lista de Espera';
...
$string['blockedtotal'] = 'inclui {$a} usuário/s bloqueado';
...
$string['deletetutorialprompt'] = 'Excluir essa lista de inscrição';
...
$string['edittutorialprompt'] = 'Editar essa lista de inscrição';
...
$string['hidesession'] = 'Visível - Ocultar Slot de Tempo';
...
$string['notimeslotediting'] = 'Uma vez que este é um novo tutorial, por favor, salve esta página e volte a criar listas de inscrição, lembre-se de definir a visibilidade para esconder isso para evitar o uso antes do tutorial ter sido completamente configurado.';
...
$string['timeslotheading'] = 'Gerenciamento de Lista de Inscrição';
...
$string['unblockuserprompt'] = 'Usuários bloqueados - Clique para desbloquear Usuário';
