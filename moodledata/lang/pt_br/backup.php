...
/**
 * Strings for component 'backup', language 'pt_br', branch 'MOODLE_34_STABLE'
 *
 * @package   backup
...
$string['filereferencesincluded'] = 'Há referências em arquivos a conteúdos externos incluídos no pacote de backup. Estas referências não funcionarão se o backup for restaurado em um outro site.';
