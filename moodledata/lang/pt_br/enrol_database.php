...
/**
 * Strings for component 'enrol_database', language 'pt_br', branch 'MOODLE_34_STABLE'
 *
...
$string['dbhost_desc'] = 'Digite o endereço IP ou nome do host do servidor de banco de dados. Utilize um nome DSN do sistema se estiver usando o ODBC. Utilize um PDO DSN se estiver usando PDO.';
