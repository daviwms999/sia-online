...
/**
 * Strings for component 'role', language 'pt_br', branch 'MOODLE_34_STABLE'
 *
 * @package   role
...
$string['backup:backuptargethub'] = 'Backup para publicação no Moodle.net';
...
$string['community:add'] = 'Use o bloco da comunidade para pesquisar o Moodle.net e encontrar cursos';
...
$string['course:publish'] = 'Publicar um curso';
...
$string['restore:restoretargethub'] = 'Restaurar cursos baixados do Moodle.net';
