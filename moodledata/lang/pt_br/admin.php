...
/**
 * Strings for component 'admin', language 'pt_br', branch 'MOODLE_34_STABLE'
 *
 * @package   admin
...
$string['allowindexing_desc'] = 'Determina se permite motores de busca indexarem seu site. "Em toda parte" permitirá aos motores de busca fazerem buscas em todo lugar, incluindo páginas de login e cadastro. Para evitar o risco de spam envolvendo a página de cadastro ser pesquisável, use "Em toda parte, exeto páginas de login e cadastro". "Lugar nenhum" dirá aos motores de busca para não indexar qualquer página. Note que isto é apenas uma tag no cabeçalho do site. Fica para o motor de busca respeitar ou não a tag.';
