...
/**
 * Strings for component 'auth_ldap', language 'pt_br', branch 'MOODLE_34_STABLE'
 *
 * @package   auth_ldap
...
$string['auth_ldap_rolecontext_help'] = 'Contexto LDAP usado para selecionar o mapeamento de <i>{$a->localname}</i>. Separe múltiplos grupos com ";" . Geralmente algo como "cn={$a->shortname},ou=staff,o=myorg".';
